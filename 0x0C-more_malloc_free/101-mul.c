...
/**
 * mul - multiplies a char with string and puts the answer in dest
 * @n: char to multiply
 * @num: string to multiply
 * @num_index: last NULL index of num
 * @dest: destination of product
 * @dest_index: highest index to start addition
 *
 * Return: pointer to dest or NULL if it fails
 */
 ...
 * Return: 0 if digits and 1 if not digits
 */
